        ...
        <body>
            ...
            <div class="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box" style="background: #103cbe;">
                <div class="featured-image mb-3">
                    <img src="imagens/gatinho_comemora.png" class="img-fluid" style="width: 250px;">
                </div>
            ...
            <form id="userData" action="" method="post">
                <div class="input-group mb-3">
                    <input type="text" name="nome" class="form-control form-control-lg bg-light fs-6" placeholder="Seu nome aqui">
                </div>
                <div class="input-group mb-3">
                    <input type="text" name="email" class="form-control form-control-lg bg-light fs-6" placeholder="Seu e-mail aqui">
                </div>
                <div class="input-group mb-1">
                    <input type="password" name="senha" class="form-control form-control-lg bg-light fs-6" placeholder="Crie uma nova senha">
                </div>
                <br>
                <div class="input-group mb-3">
                    <button class="btn btn-lg btn-primary w-100 fs-6" type="submit">Criar conta</button>
                </div>
            </form>
        </div>
        </div>
