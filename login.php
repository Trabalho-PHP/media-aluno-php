    ...
    <div class="row align-items-center">
            ...
            <form action="" method="post">
                <div class="input-group mb-3">
                    <input for="email" type="text" class="form-control form-control-lg bg-light fs-6" placeholder="Email">
                </div>
                <div class="input-group mb-1">
                    <input for="senha" type="password" class="form-control form-control-lg bg-light fs-6" placeholder="Senha">
                </div>
